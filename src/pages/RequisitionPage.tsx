...
import { PRService, ProjectService, ProductService } from '@/services/store';
import { PurchaseRequisition, Project, Product } from '@/types';
...
import { Plus, FileText, CheckCircle2, XCircle, Clock, Trash2 } from 'lucide-react';
...
export default function RequisitionPage() {
  ...
  useEffect(() => {
    ...
    return () => { unsubPR(); unsubProjects(); unsubProducts(); };
  }, []);
          ...
          <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                 ...
                 {items.length === 0 && <div className="text-center py-8 text-slate-400 italic text-sm italic">Add materials to request.</div>}
              </div>
